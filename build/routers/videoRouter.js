...
videoRouter.get(_routes["default"].videos, function (req, res) {
...
videoRouter.get(_routes["default"].editVideo(), _middlewares.onlyPrivate, _videoController.getEditVideo); // 1st param: function type
